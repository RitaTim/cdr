	...
	f.extend(b, {
		...
		_afterZoomIn: function() {
			...
			a && (b.isOpen = b.isOpened = !0, b.wrap.css("overflow", "visible").addClass("fancybox-opened"), b.update(), (a.closeClick || a.nextClick && 1 < b.group.length) && b.inner.css("cursor", "pointer").bind("click.fb", function(d) {
				...
				a.preventDefault();
				//user code	
				var url_search = window.window.location.search;
				var path_clear = window.location.pathname;
				if( !(path_clear.indexOf('vacancy') == -1) ){
					path_clear = '/about/vacancy.php?clear_cache=Y';
				}
				console.log(path_clear);
				if (!(url_search.indexOf("success-msg") == -1 && url_search.indexOf("success_message") == -1 && url_search.indexOf("strIMessage") == -1)){ window.location.replace(path_clear);};
				// end user code
				b.close()
