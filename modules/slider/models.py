...
class Slider(models.Model):
	...
	title_h1 = models.CharField(u"Главный заголовок", max_length=30, blank=True,
	                            null=True)
	title_h2 = models.CharField(u"Заголовок второго уровня", max_length=50,
	                            blank=True, null=True)
	title_btn = models.CharField(u"Название кнопки", max_length=10, blank=True,
	                             null=True)
	href_btn = models.CharField(u"Ссылка кнопки", max_length=40, blank=True,
	                            null=True)
